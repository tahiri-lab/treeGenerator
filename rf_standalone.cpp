	...
	for (k = 1; k <= MatrixNumber; k++) {
		...
		*/
		...
		//========================================		
			...
			/*for(int k=1; k<=m; k++){
				for(int l=1; l<=finalTaille; l++){printf("%d \t", B[PLACE1[k]][l]);}
				printf("\n");
			}
			printf("\nDeuxième matrice\n");

			for(int k=1; k<=m1; k++){
				for(int l=1; l<=finalTaille; l++){printf("%d \t", BI[PLACE2[k]][l]);}
				printf("\n");
			}
			printf("\nMAtrices distances\n");

			for(int k=1; k<=finalTaille; k++){
				for(int l=1; l<=finalTaille; l++){printf("%f \t", DISSopt[k][l]);}
				printf("\n");
			}
			printf("\nDeuxième matrice\n");

			for(int k=1; k<=finalTaille; k++){
				for(int l=1; l<=finalTaille; l++){printf("%f \t", DISS_opt[k][l]);}
				printf("\n");
			}*/
